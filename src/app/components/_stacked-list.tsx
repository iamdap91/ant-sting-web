...
import { DebentureReport } from "@/app/interfaces";
...
const figureFontColor = (score: number) => {
  switch (true) {
    case score > 3:
      return "text-red-500";
    case score < 3:
...
export default function _stackedList({ data }: { data: DebentureReport[] }) {
  return (
        ...
        >
          <div>
            ...
            <div className="mt-1 flex items-center gap-x-2 text-xs leading-5 text-gray-500">
              ...
              <p>
                <time dateTime={discussion.date}>{discussion.date}</time>
              </p>
            </div>
          </div>
          <dl className="flex w-full flex-none justify-between gap-x-8 sm:w-auto">
            <div className="flex -space-x-0.5">
              <span className={figureFontColor(discussion.scoreInfo.avgScore)}>
                {discussion.scoreInfo.avgScore}
              </span>
            ...
            <div className="flex w-16 gap-x-2.5">
              ...
              {/*<dd className="text-sm leading-6 text-gray-100">*/}
