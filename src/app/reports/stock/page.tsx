                  ...
                  <div className="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
                    <table className="min-w-full divide-y divide-gray-700">
                      ...
                      <tbody className="divide-y divide-gray-800">
                        {(reports || []).map(
                          (report: StockReport, idx: number) => (
                            <tr key={report.stockName}>
                              <td className="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-500 sm:pl-0">
                                {report.stockName}
                              </td>
                              <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-300 hover:underline">
                                <Link
                                  href={joinUrl(
                                    N_PAY_RESEARCH_URL,
                                    report.detailUrl,
                              ...
                              <td
                                className={`whitespace-nowrap px-3 py-4 text-sm ${opinionFontStyle(report.recommendation?.position)}`}
                              >
                                {report.recommendation?.position}
                              </td>
                              <td className="whitespace-nowrap px-3 py-4 text-xs text-gray-600">
                                {report.recommendation?.price?.toLocaleString() ||
                                  "-"}
                              </td>
                              <td className="whitespace-nowrap px-3 py-4 text-xs text-gray-400">
