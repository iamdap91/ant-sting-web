...
import { AiScore, DebentureReport, InvestReport } from "@/app/interfaces";
import {
  Dialog,
  DialogBackdrop,
  DialogPanel,
...
export default function InvestPage() {
  ...
  const {
    ...
    error,
    isLoading,
  } = useSWR(`/api/invest-reports?date=${value.startDate}`, fetcher);
  console.log(reports);
      ...
      <div className="container p-8">
        ...
        <div className="container p-8">
          ...
          <ul role="list" className="divide-y divide-gray-900">
            {(reports || []).map((report: InvestReport, idx: number) => (
              <li
                key={report._id}
