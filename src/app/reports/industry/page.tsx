...
import { AiScore, DebentureReport, IndustryReport } from "@/app/interfaces";
import {
  Dialog,
  DialogBackdrop,
  DialogPanel,
...
export default function IndustryPage() {
  ...
  const {
    ...
    error,
    isLoading,
  } = useSWR(`/api/industry-reports?date=${value.startDate}`, fetcher);
  console.log(reports);
      ...
      <div className="container p-8">
        ...
        <div className="container p-8">
          ...
          <ul role="list" className="divide-y divide-gray-900">
            {(reports || []).map((report: IndustryReport, idx: number) => (
              <li
                key={report._id}
